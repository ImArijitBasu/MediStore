...
export const FeaturedMedicinesSkeleton = () => {
  return (
    <section className="py-12 bg-linear-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      <div className="container mx-auto px-4">
        {/* Header Skeleton */}
        <div className="text-center mb-10">
          <div className="h-10 bg-gray-200 dark:bg-gray-700 rounded w-64 mx-auto mb-4 animate-pulse"></div>
          <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-96 max-w-full mx-auto mb-2 animate-pulse"></div>
          <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-80 max-w-full mx-auto animate-pulse"></div>
          <div className="mt-4 flex items-center justify-center gap-2">
            <div className="w-8 h-1 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
            <div className="w-3 h-1 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
            <div className="w-3 h-1 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
          </div>
        </div>
        ...
        <div className="text-center mt-10">
          <div className="inline-block h-12 bg-gray-200 dark:bg-gray-700 rounded-lg w-48 animate-pulse"></div>
        </div>
      </div>
    </section>
  );
